...
<tbody>
<!-- 循环部门列表 -->
<s:iterator var="dep" value="list">
<tr>
<td align="center"><s:property value="#dep.dname"/></td>
<td align="center"><a href="department_edit.action?did=<s:property value="#dep.did"/>"><img src="${pageContext.request.contextPath}/images/编辑.png"/></a></td>
<td align="center"><a href="department_delete.action?did=<s:property value="#dep.did"/>" onclick="javascript: return confirm('真的要删除吗？');">删除</a></td>
</tr>
</s:iterator>
</tbody>
</table>
...
<tr>
<td align="right">
   <span>第<s:property value="currentPage"/>/<s:property value="totalPage"/>页
   &nbsp;&nbsp;总共有 <s:property value="totalPage"/>页 &nbsp;&nbsp;总共有<s:property value="totalCount"/>条记录</span>
   <span>
